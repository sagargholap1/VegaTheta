      ...
      >
        <div className="flex w-full h-full">
          ...
          <div className="basis-1/2  flex-col gap-[2rem] items-center justify-center flex  ">
            <h1 className="text-[3rem]">Welcome to VegaTheta</h1>
            <form
              action=""
            ...
            >
              ...
              <input
                ...
                className=" h-[4rem] outline-none  rounded-[.3rem]"
              />
              <label htmlFor="Email" className="text-[#4D5959]">
                Password
              </label>
              ...
              <div className="flex justify-between">
                <div className="flex gap-[1rem]">
                  <input type="checkbox" name="" id="" className="accent-[#007074]" />
                  <label htmlFor="" className="text-[#4D5959]">
                    Remember Me
                  </label>
                </div>
                <div className="text-[#4D5959] underline hover:text-[#007074]"><Link href="/">
                Forgot Password?
                </Link>
                </div>
              </div>
            ...
            <div className="flex gap-[2rem]">
              <button className="flex p-[1rem] items-center justify-center gap-[1rem] border-[2px]">
                ...
                <span className="text-[1.2rem] text-[#043133] font-5">Sign Up with Google</span>
              </button>
              <button className="flex p-[1rem] items-center justify-center gap-[1rem] border-[2px]">
                <div className="w-[2rem] h-[2rem]">
                  <Image src={GitIcon} alt="icon" />
                </div>
                <span className="text-[1.2rem] text-[#043133] font-5">Sign Up with Github</span>
              </button>
            </div>

            <div className=" text-[1.2rem] font-6">2023 @ All Rights Reserved</div>
          </div>
        </div>
      </div>
    </section>
